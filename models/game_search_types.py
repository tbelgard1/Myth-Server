"""
Game search types module for Myth metaserver.

Contains data structures for game parameters and descriptions,
including game creation parameters and metaserver game descriptions.
"""
...
class NewGameParameterData:
    ...
    This class represents the configuration parameters needed when creating
    a new game on the metaserver. It includes game type, scoring rules,
    player limits, and other game settings.
    """
    type: int
    scoring: int
    option_flags: int
    ...
    def pack(self) -> bytes:
        ...
        Returns:
            Byte string containing packed parameter data
        """
    ...
    def unpack(cls, data: bytes) -> 'NewGameParameterData':
        ...
        Args:
            data: Byte string containing packed parameter data
            
        Returns:
            NewGameParameterData object initialized from byte data
        """
        params = cls()
        (params.type,
         params.scoring,
...
class MetaserverGameDescription:
    ...
    This class represents a game's description as it appears on the metaserver.
    It includes the game parameters as well as additional metaserver-specific
    information like checksums and player counts.
    """
    ...
    def pack(self) -> bytes:
        ...
        Returns:
            Byte string containing packed description data
        """
        return (
    ...
    def unpack(cls, data: bytes) -> 'MetaserverGameDescription':
        ...
        Args:
            data: Byte string containing packed description data
            
        Returns:
            MetaserverGameDescription object initialized from byte data
        """
        desc = cls()
